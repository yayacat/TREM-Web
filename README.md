...
# Taiwan Real-time Earthquake Monitoring Web
臺灣即時地震監測 網頁版
...
TREM Web 是一款開源地震速報網頁應用程式，提供給您即時的地震資訊，在地震發生的第一時間取得各管道發布的強震即時警報訊息
...
#### Web
- [點我前往](https://exptechtw.github.io/TREM-Web/build/web/)
